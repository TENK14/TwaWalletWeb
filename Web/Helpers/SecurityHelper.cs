...
namespace TwaWallet.Web.Helpers
{
    public class SecurityHelper
    {
        //public string ToAbsoluteUrl(this string relativeUrl) //Use absolute URL instead of adding phycal path for CSS, JS and Images     
        //{
